...
foreach(_cmake_expected_target IN ITEMS mmdeploy_trt_net mmdeploy_ort_net mmdeploy mmdeploy_cxx_api)
...
# Create imported target mmdeploy_trt_net
add_library(mmdeploy_trt_net SHARED IMPORTED)

set_target_properties(mmdeploy_trt_net PROPERTIES
  INTERFACE_LINK_LIBRARIES "nvinfer;nvinfer_plugin;cudnn;cuda"
)

# Create imported target mmdeploy_ort_net
add_library(mmdeploy_ort_net SHARED IMPORTED)
